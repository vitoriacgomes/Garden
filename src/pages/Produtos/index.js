            ...
            <div classNameName="container px-5 py-24 mx-auto">
                <div classNameName="flex flex-wrap -m-4">
                    <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div className="mt-4">
                            <h3 className="categoria-produtos text-xs tracking-widest title-font mb-1">CATEGORY</h3>
                            <h2 className="name-produtos title-font text-lg font-medium">The Catalyzer</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div className="mt-4">
                            <h3 className="categoria-produtos text-xs tracking-widest title-font mb-1">CATEGORY</h3>
                            <h2 className="name-produtos title-font text-lg font-medium">Shooting Stars</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div className="mt-4">
                            <h3 className="categoria-produtos text-xs tracking-widest title-font mb-1">CATEGORY</h3>
                            <h2 className="name-produtos title-font text-lg font-medium">Neptune</h2>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div className="mt-4">
                            <h3 className="categoria-produtos text-xs tracking-widest title-font mb-1">CATEGORY</h3>
                            <h2 className="name-produtos title-font text-lg font-medium">The 400 Blows</h2>
